...
setup(
    name=package_name,
    version='0.0.1',
    packages=[package_name],  # non-src layout: antbot_drive_controller ต้องมี __init__.py
    data_files=[
    ...
    description='Teleop + mux + Twist->TwistStamped bridge for Antbot',
    entry_points={
        'console_scripts': [
            # เอาอันนี้ออกถ้ายังไม่มีไฟล์
